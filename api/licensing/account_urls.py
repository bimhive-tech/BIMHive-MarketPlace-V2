...
urlpatterns = [
    ...
    path("checkout/status", CheckoutStatusView.as_view(), name="account-checkout-status"),
    ...
    path("subscriptions", AccountSubscriptionListView.as_view(), name="account-subscriptions"),
    path("payment-methods", AccountPaymentMethodListView.as_view(), name="account-payment-methods"),
