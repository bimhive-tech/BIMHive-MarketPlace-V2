...
class ActivityVerb(models.TextChoices):
    ...
    PARTNER_APPROVED = "partner_approved", "Approved a seller application"
    PARTNER_REJECTED = "partner_rejected", "Rejected a seller application"
    PARTNER_RESUBMITTED = "partner_resubmitted", "Resubmitted a seller application"
